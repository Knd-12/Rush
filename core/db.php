...
class Db {
    ...
    protected function save_img($target_dir = APP_ROOT."/public/assets/img_uploads/", $inputNameAttr = "fileToUpload"){
        ...
        if( !empty($_FILES[$inputNameAttr]["name"]) ){
            ...
            && $imageFileType != "gif" && $imageFileType != "mov" && $imageFileType != "mp4" ) {
                $file_upload['file_upload_error_status'] = 1;
                $file_upload['errors'][] = "Only JPG, JPEG, PNG, GIF, MP4 & MOV files are allowed.";
            }
