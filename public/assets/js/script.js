            ...
            $.post('/api/comments/add.php', {"post_id" : post_id, "comment" : comment}, function(apiData){
                ...
                if ( apiData.error == false ) {
                    ...
                    $.each(apiData.comments, function(index, comment){
                        ...
                        commentLoopHtml += `
                            <div class="user-comment text-dark">
                        `;
                ...
                if ( post.user_owns == 'true' ) {
                    postsFeedHtml += `
                        ...
                        <span class="float-right">
                            <a class="text-primary" href="/posts/edit.php?id=${post.id}">
                ...
                postsFeedHtml += `
                    ...
                    <div class="card-body post-body" data-postid="${post.id}">
                            ...
                            <video width="320" height="240" controls>
                                <source src="/assets/img_uploads/${post.filename}" type="video/mp4">
                                <source src="/assets/img_uploads/${post.filename}" type="video/quicktime">
                        ...
                        <p>Posted on: ${moment.unix(post.posted_time).tz(post.timezone).format("D MMMM YYYY, h:mm a")}</p>
                        ...
                        <form class="mt-3 comment-form">
                            <input class="form-control text-dark comment-box" type="text" name="comment" placeholder="Write a comment...">
                        </form>
